package net.micropact.aea.du.page.schedulerJobStatusStandalone;
...
/**
 * Controller code for a page which displays the status of scheduler jobs.
 *
 * @author Zachary.Miller
 */
@HandlerScript(type = PageController.class)
public class SchedulerJobStatusStandaloneController implements PageController {
    ...
    public Response execute(final PageExecutionContext etk) throws ApplicationException {
        ...
        BreadcrumbUtility.setBreadcrumbAndTitle(response,
                BreadcrumbUtility.addLastChildFluent(
                        ...
                        new SimpleBreadcrumb("Scheduler Job Status",
                                "page.request.do?page=du.page.schedulerJobStatusStandalone")));
