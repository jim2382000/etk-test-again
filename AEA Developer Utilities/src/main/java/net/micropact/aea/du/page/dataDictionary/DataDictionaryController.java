package net.micropact.aea.du.page.dataDictionary;
...
/**
 * Controller code for a page which provides access for downloading the data dictionary.
 *
 * @author Zachary.Miller
 */
@HandlerScript(type = PageController.class)
public class DataDictionaryController implements PageController {
    ...
    public Response execute(final PageExecutionContext etk) throws ApplicationException {
        ...
        BreadcrumbUtility.setBreadcrumbAndTitle(response,
                BreadcrumbUtility.addLastChildFluent(
                        ...
                        new SimpleBreadcrumb("Data Dictionary",
                                "page.request.do?page=du.page.dataDictionary")));
