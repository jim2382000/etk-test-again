package net.micropact.aea.du.page.updateLogViewer;
...
/**
 * Controller code for a page which displays the update log.
 *
 * @author Zachary.Miller
 */
@HandlerScript(type = PageController.class)
public class UpdateLogViewerController implements PageController {
    ...
    public Response execute(final PageExecutionContext etk) throws ApplicationException {
        ...
        BreadcrumbUtility.setBreadcrumbAndTitle(response,
                BreadcrumbUtility.addLastChildFluent(
                        ...
                        new SimpleBreadcrumb("View Update Log",
                                "page.request.do?page=du.page.updateLogViewer")));
