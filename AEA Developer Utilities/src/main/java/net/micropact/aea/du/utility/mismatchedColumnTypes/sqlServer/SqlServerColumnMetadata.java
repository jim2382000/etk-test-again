...
/**
 * Class representing a single record in SQL Server's information_schema.columns table.
 *
 * @author Zachary.Miller
 */
public class SqlServerColumnMetadata implements IDatabaseColumnMetadata{
     ...
     * @param theCharacterMaximumLength CHARACTER_MAXIMUM_LENGTH
     * @param theNumericPrecision NUMERIC_PRECISION
     * @param theNumericScale NUMERIC_SCALE
     * @param theDatetimePrecision DATETIME_PRECISION
     */
    public SqlServerColumnMetadata(final String theTableName, final String theColumnName, final String theDataType,
    ...
    public boolean equals(final Object other) {
        if(other == null || getClass() != other.getClass()){
            ...
            final SqlServerColumnMetadata otherImpl = (SqlServerColumnMetadata) other;
    ...
    public String toString() {
        return String.format("TableName: %s, ColumnName: %s, DataType: %s, CharacterMaximumLength: %s, NumericPrecision: %s, NumericScale: %s, DatetimePrecision: %s",
                getTableName(),
                getColumnName(),
                getDataType(),
                getCharacterMaximumLength(),
