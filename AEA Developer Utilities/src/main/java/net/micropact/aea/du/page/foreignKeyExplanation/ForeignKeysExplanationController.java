package net.micropact.aea.du.page.foreignKeyExplanation;
...
/**
 * Controller code for a page which provides the download link for the Foreign Keys Developer Utility.
 *
 * @author Zachary.Miller
 */
@HandlerScript(type = PageController.class)
public class ForeignKeysExplanationController implements PageController {
    ...
    public Response execute(final PageExecutionContext etk) throws ApplicationException {
        ...
        BreadcrumbUtility.setBreadcrumbAndTitle(response,
                BreadcrumbUtility.addLastChildFluent(
                        ...
                        new SimpleBreadcrumb("Foreign Keys",
                                "page.request.do?page=du.page.foreignKeyExplanation")));
